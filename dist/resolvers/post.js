...
let PostResolver = class PostResolver {
    ...
    voteState(post, { updootLoader, req }) {
    ...
    posts(limit, cursor, { AppDataSource }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const posts = yield AppDataSource.query(`
    select p.*
    from post p
    ...
    updatePost(id, title, text, { req, AppDataSource }) {
        return __awaiter(this, void 0, void 0, function* () {
...
__decorate([
    (0, type_graphql_1.FieldResolver)(() => User_1.BUser),
    __param(0, (0, type_graphql_1.Root)()),
...
], PostResolver.prototype, "voteState", null);
__decorate([
